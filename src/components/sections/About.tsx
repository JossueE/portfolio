    ...
    <section id="about" className="section-pad relative" aria-label="About">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
        ...
        <ScrollReveal
          ...
          className="max-w-4xl text-balance text-2xl font-medium leading-[1.3] tracking-tight sm:text-3xl lg:text-[2.4rem] lg:leading-[1.25]"
        >
        ...
        <motion.p
          ...
          className="max-w-2xl text-pretty text-base leading-relaxed text-muted/70"
        >
        ...
        >
          {CAPABILITIES.map((cap, i) => (
            <motion.li
              ...
              className="flex items-center gap-x-5 text-sm font-medium text-fg/75"
            >
